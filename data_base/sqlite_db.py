...
def sql_start():
    ...
    base.execute('CREATE TABLE IF NOT EXISTS assortmen(img TEXT, name TEXT PRIMARY KEY, description TEXT, price TEXT)')
    base.commit()
...
async def sql_delete_command(data):
    cur.execute('DELETE FROM assortment WHERE name == ?', (data,))
    base.commit()